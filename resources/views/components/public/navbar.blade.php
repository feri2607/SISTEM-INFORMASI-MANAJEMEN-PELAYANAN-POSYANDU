            ...
            @auth
                @if(auth()->user()->hasRole('warga') || auth()->user()->hasRole('user'))
                    <div x-data="{ open: false }">
                        ...
                        <div x-show="open" x-cloak class="pl-4 mt-1 space-y-1">
                            <a href="{{ route('warga.balita.index') }}"
                               class="block px-3 py-2 text-base text-gray-600 dark:text-gray-400 rounded-lg hover:bg-teal-50 dark:hover:bg-teal-900/30 hover:text-teal-700">Balita</a>
                            <a href="{{ route('warga.kehamilan.index') }}"
                               class="block px-3 py-2 text-base text-gray-600 dark:text-gray-400 rounded-lg hover:bg-teal-50 dark:hover:bg-teal-900/30 hover:text-teal-700">Kehamilan</a>
                            <a href="{{ route('warga.menyusui.index') }}"
                               class="block px-3 py-2 text-base text-gray-600 dark:text-gray-400 rounded-lg hover:bg-teal-50 dark:hover:bg-teal-900/30 hover:text-teal-700">Menyusui</a>
                            <a href="{{ route('warga.reproduksi.index') }}"
                               class="block px-3 py-2 text-base text-gray-600 dark:text-gray-400 rounded-lg hover:bg-teal-50 dark:hover:bg-teal-900/30 hover:text-teal-700">WUS / PUS</a>
                            <a href="{{ route('warga.remaja.index') }}"
                               class="block px-3 py-2 text-base text-gray-600 dark:text-gray-400 rounded-lg hover:bg-teal-50 dark:hover:bg-teal-900/30 hover:text-teal-700">Remaja</a>
                            <a href="{{ route('warga.lansia.index') }}"
                               class="block px-3 py-2 text-base text-gray-600 dark:text-gray-400 rounded-lg hover:bg-teal-50 dark:hover:bg-teal-900/30 hover:text-teal-700">Lansia</a>
                        </div>
                    </div>
                @endif
            @endauth
