...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in-up">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-4">
        <div class="flex flex-wrap gap-2">
            <div class="inline-flex items-center px-4 py-2 bg-indigo-50 text-indigo-700 text-sm font-semibold rounded-lg border border-indigo-100">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                Tergabung Sesuai Usia & Dokumen (Profil Saya)
            </div>
        </div>
    </div>
