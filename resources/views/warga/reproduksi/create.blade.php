{{-- resources/views/warga/reproduksi/create.blade.php --}}

@extends('layouts.public')

@section('title', 'Tambah Data WUS - Sistem Informasi Posyandu')

@section('page-title', '🩺 Tambah Data WUS')
@section('page-subtitle', 'Isi data Wanita Usia Subur (WUS) untuk pelayanan kesehatan reproduksi.')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden">
        <div class="p-6">
            <form method="POST" action="{{ route('warga.reproduksi.store') }}" 
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="status_pernikahan" id="status_pernikahan" 
                            ...
                            @foreach($statusPernikahan as $status)
                                <option value="{{ $status }}" {{ old('status_pernikahan') == $status ? 'selected' : '' }}>
                                    {{ $status }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <textarea name="riwayat_penyakit" id="riwayat_penyakit" rows="3" 
                                  class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent text-gray-900 dark:text-white">{{ old('riwayat_penyakit') }}</textarea>
                    </div>
                    ...
                    <div class="p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                        <p class="text-sm text-blue-700 dark:text-blue-300">
                            ...
                            Data akan diverifikasi oleh pegawai Posyandu. 
