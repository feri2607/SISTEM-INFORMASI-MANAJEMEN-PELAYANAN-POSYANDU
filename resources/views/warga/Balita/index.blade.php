...
<div class="space-y-6">
    ...
    {{-- Info Blok Data Balita --}}
    <div class="bg-blue-50 dark:bg-blue-900/30 rounded-2xl shadow-sm p-4 border border-blue-100 dark:border-blue-800">
        <p class="text-sm text-blue-700 dark:text-blue-300">
            ...
            Untuk menambah data balita, tambahkan melalui menu <strong><a href="{{ route('profile.index') }}#data-anak" class="underline font-bold">Profil Saya (Data Anak)</a></strong>. Data anak yang berusia di bawah 5 tahun akan otomatis masuk ke daftar ini.
        </p>
    </div>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <a href="{{ route('profile.index') }}" class="mt-3 px-4 py-2 bg-[#036672] hover:bg-[#036672] text-white rounded-lg transition duration-150">
