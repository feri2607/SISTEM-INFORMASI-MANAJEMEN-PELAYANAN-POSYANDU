{{-- resources/views/warga/lansia/create.blade.php --}}

@extends('layouts.public')

@section('hide-footer', true)
@section('title', 'Tambah Data Lansia - Sistem Informasi Posyandu')
@section('page-title', '👴 Tambah Data Lansia')
@section('page-subtitle', 'Isi data identitas lansia untuk layanan Posyandu Lansia.')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden border border-gray-100 dark:border-gray-700">
        <div class="p-6">
            <form method="POST" action="{{ route('warga.lansia.store') }}"
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <p x-show="usia !== null" class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Usia: <span class="font-semibold" x-text="usia"></span>
                        </p>
                    ...
                    <div>
                        ...
                        <textarea name="alamat" id="alamat" rows="3"
                                  class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent text-gray-900 dark:text-white transition">{{ old('alamat') }}</textarea>
                    ...
                    <div>
                        ...
                        @error('golongan_darah')<p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>@enderror
                    </div>
                    ...
                    <div>
                        ...
                        @error('no_hp')<p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>@enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="riwayat_penyakit" id="riwayat_penyakit" rows="3"
                                  ...
                                  class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent text-gray-900 dark:text-white transition">{{ old('riwayat_penyakit') }}</textarea>
                        @error('riwayat_penyakit')<p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>@enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="w-20 h-20 rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 flex-shrink-0">
                                <img id="fotoPreview"
                                     src="https://ui-avatars.com/api/?name=Lansia&color=7F9CF5&background=EBF4FF&size=100"
                            ...
                            <div class="flex-1">
                                <input type="file" name="foto" id="foto"
                                       ...
                                       class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100 dark:file:bg-teal-900/30 dark:file:text-teal-400">
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Format: JPG, PNG, WebP (Maks. 2 MB)</p>
                            </div>
                        </div>
                    ...
                    <div class="p-4 bg-blue-50 dark:bg-blue-900/30 rounded-xl border border-blue-200 dark:border-blue-800">
                        <p class="text-sm text-blue-700 dark:text-blue-300 flex items-start gap-2">
                            ...
                            Data identitas lansia akan diverifikasi oleh pegawai Posyandu. Data kesehatan (tekanan darah, gula darah, kolesterol, dll.) hanya dapat diisi oleh pegawai saat pelayanan.
                        </p>
                    </div>
