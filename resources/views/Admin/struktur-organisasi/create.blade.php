...
<div class="p-6 max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Pengurus</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Tambahkan data pengurus/kader baru ke struktur organisasi.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.struktur-organisasi.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="nama" value="{{ old('nama') }}"
                       ...
                       placeholder="Nama pengurus/kader">
            ...
            <div>
                ...
                <input type="text" name="jabatan" value="{{ old('jabatan') }}"
                       class="w-full rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 px-4 py-2.5 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                       placeholder="Ketua, Bidan Desa, Kader, ...">
        ...
        <div>
            ...
            <img id="foto_preview" class="mt-3 h-24 w-24 rounded-full object-cover hidden" src="" alt="preview">
            <p class="text-xs text-gray-400 mt-1">Jika tidak diisi, avatar otomatis akan digunakan.</p>
        </div>
        ...
        <div>
            ...
            <textarea name="deskripsi" rows="3"
                      class="w-full rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 px-4 py-2.5 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                      placeholder="Catatan singkat...">{{ old('deskripsi') }}</textarea>
        </div>
