...
@section('title', 'Tambah Pengumuman - Sistem Informasi Posyandu')

@section('page-title', 'Tambah Pengumuman')
@section('page-subtitle', 'Buat pengumuman baru untuk Posyandu')
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="priority" id="priority" 
                                ...
                                <option value="very_important" {{ old('priority') == 'very_important' ? 'selected' : '' }}>Sangat Penting</option>
                            </select>
                            @error('priority')
                                <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                    ...
                    <div>
                        ...
                        <textarea name="excerpt" id="excerpt" rows="3" 
                                  class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-gray-900 dark:text-white"
                                  placeholder="Ringkasan pengumuman...">{{ old('excerpt') }}</textarea>
                        @error('excerpt')
                            <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="15" 
                                  ...
                                  placeholder="Tulis konten pengumuman di sini...">{{ old('content') }}</textarea>
                        @error('content')
                            <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
